...
Implement the primary discovery surface of the Web B2C application: an interactive Google Maps-powered map with event pins, clustering, and filters, alongside SSR city and category listing pages that are SEO-ready from day one. This is the main landing experience for all users arriving at the site.

## Deliverables

### 1. Map and Discovery Page

- [ ] P0 Main page: map with event pins (Google Maps JS API — see [ARCHITECTURE.md ADR #17](../../documentation/ARCHITECTURE.md#11-key-architectural-decisions-log))
...
- The main page (`/`) loads the Google Maps JS API and renders event pins on the map
